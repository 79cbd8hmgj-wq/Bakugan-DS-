...
from bakugan_ds.analysis.model import Component, NumericMatch
...
def cluster_numeric_matches(
    matches: tuple[NumericMatch, ...], *, max_gap: int = 0x80
) -> tuple[dict[str, object], ...]:
    """Group nearby matches without claiming that the surrounding bytes share a schema."""
    if max_gap < 0:
