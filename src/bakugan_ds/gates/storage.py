...
SYSTEM2_STORAGE_DECISION = StorageDecision(
    ...
    candidates=(
        ...
        StorageCandidate(
            ...
            confirmed_requirements=(
                ...
                "Reserve a 64-byte selected-record cache by increasing overlay-7 BSS from 0x640 to 0x680.",
                "Move the ARM9 battle-arena low boundary from 0x0228BC20 to 0x0228BC60 atomically with the BSS metadata change.",
                "The arena high boundary is 0x023E0000, leaving 1,393,568 bytes after the 64-byte reservation.",
            ...
            unresolved_requirements=(),
            risks=(
                "Milestone 6B must add guarded overlay-metadata patch support for the BSS field.",
    ...
    evidence=(
        ...
        "Overlay-7 BSS metadata is 0x640 at ROM offset 0x000718EC.",
    ),
)
